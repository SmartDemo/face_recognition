...
if __name__ == '__main__':
    ...
    bboxes, landmarks = create_mtcnn_net(image, args.mini_face, device, p_model_path='weights/pnet_Weights.pt', r_model_path='weights/rnet_Weights', o_model_path='weights/onet_Weights.pt')
